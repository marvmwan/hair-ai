...
const scanSlides = [
  {
    key: 'side',
    image: require('../../../assets/images/hair-scan-info/side-view.jpeg'),
    title: 'Side view',
    description:
  ...
  },
  {
    ...
    description: 'It is okay if your head is not centered in the view, as long as the lower hairline is visible.',
  },
  {
    key: 'top',
    image: require('../../../assets/images/hair-scan-info/top-view.jpeg'),
    title: 'Top view (Crown)',
    description: 'For density, volume, and Norwood stage. Ensure hair is spread evenly so the scalp can be seen.',
  },
  {
    key: 'front',
...
const HairScanInfoScreen: React.FC<HairScanInfoScreenProps> = ({ onContinue, onBack, progress }) => {
    ...
    <View style={styles.container}>
      ...
      {/* <ScrollView> */}
        <View style={styles.header}>
          <Text style={styles.title}>Scan for 20+ hair attributes</Text>
        ...
        <View style={styles.pagination}>
          {scanSlides.map((_, index) => (
            <View
              key={index}
              style={[styles.dot, { backgroundColor: index === activeIndex ? colors.primary : colors.gray.medium }]}
            />
          ))}
        </View>
      {/* </ScrollView> */}
      ...
      <View style={styles.buttonContainer}>
        <Button title="Start Scanning" onPress={onContinue} size="large" style={styles.button} textStyle={styles.buttonText} />
      </View>
    </View>
  );
};
